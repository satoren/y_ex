defmodule Yex.WeakTest do
  ...
  describe "text quote" do
    ...
    test "test cast", %{doc: doc} do
      ...
      assert "bc" = WeakLink.to_string(l1)
      # TODO: yrs doesn’t have a type-checking mechanism, it allows unsafe method calls.
      assert "d" = WeakLink.deref(l1)
      assert ["b", "c"] = WeakLink.to_list(l1)
    end
  end
  ...
  describe "array quote" do
    ...
    test "test cast" do
      ...
      # TODO: yrs doesn’t have a type-checking mechanism, it allows unsafe method calls.
      assert "" = WeakLink.to_string(l1)
      assert "4" = WeakLink.deref(l1)
    end
  end
