defmodule Yex.Nif do
  ...
  def prune_pending_v1(_doc, _cur_txn), do: :erlang.nif_error(:nif_not_loaded)
  def update_gaps_v1(_doc, _cur_txn, _update), do: :erlang.nif_error(:nif_not_loaded)
  ...
  def undo_manager_can_undo(_undo_manager), do: :erlang.nif_error(:nif_not_loaded)
  def undo_manager_can_redo(_undo_manager), do: :erlang.nif_error(:nif_not_loaded)
