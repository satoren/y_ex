defmodule Yex.XmlElement do
  ...
  def length(%__MODULE__{} = xml_element) do
    Yex.Nif.xml_element_length(xml_element)
  end

  def insert(%__MODULE__{} = xml_element, index, content) do
    Yex.Nif.xml_element_insert(xml_element, index, content)
  end

  def delete(%__MODULE__{} = xml_element, index, length) do
    Yex.Nif.xml_element_delete_range(xml_element, index, length) |> Yex.Nif.Util.unwrap_tuple()
  end
  ...
  def get(%__MODULE__{} = xml_element, index) do
    Yex.Nif.xml_element_get(xml_element, index) |> Yex.Nif.Util.unwrap_tuple()
  end

  def insert_attribute(%__MODULE__{} = xml_element, key, value) do
    Yex.Nif.xml_element_insert_attribute(xml_element, key, value)
  end

  def remove_attribute(%__MODULE__{} = xml_element, key) do
    Yex.Nif.xml_element_remove_attribute(xml_element, key)
  end

  def get_attribute(%__MODULE__{} = xml_element, key) do
    Yex.Nif.xml_element_get_attribute(xml_element, key)
  end

  def get_attributes(%__MODULE__{} = xml_element) do
    Yex.Nif.xml_element_get_attributes(xml_element)
  end

  def next_sibling(%__MODULE__{} = xml_element) do
    Yex.Nif.xml_element_next_sibling(xml_element)
  end

  def prev_sibling(%__MODULE__{} = xml_element) do
    Yex.Nif.xml_element_prev_sibling(xml_element)
  end

  def to_string(%__MODULE__{} = xml_element) do
    Yex.Nif.xml_element_to_string(xml_element)
  end
end
